	                ...
	                <div class="all">
	                    <div class="slider">
	                        <div class="owl-carousel owl-theme main">
	                            <div style="background-image: url(/resources/img/products/lunchboxes/3_1.png);" class="item-box"></div>
	                            <div style="background-image: url(/resources/img/products/lunchboxes/3_2.png);" class="item-box"></div>
	                            <div style="background-image: url(/resources/img/products/lunchboxes/3_3.png);" class="item-box"></div>
	                            <div style="background-image: url(/resources/img/products/lunchboxes/3_4.png);" class="item-box"></div>
	                            <div style="background-image: url(/resources/img/products/lunchboxes/3_5.png);" class="item-box"></div>
	                            <div style="background-image: url(/resources/img/products/lunchboxes/3_6.png);" class="item-box"></div>
	                        </div>
	                    ...
	                    <div class="slider-two">
	                        <div class="owl-carousel owl-theme thumbs">
	                            <div style="background-image: url(/resources/img/products/lunchboxes/3_1.png);" class="item active"></div>
	                            <div style="background-image: url(/resources/img/products/lunchboxes/3_2.png);" class="item"></div>
	                            <div style="background-image: url(/resources/img/products/lunchboxes/3_3.png);" class="item"></div>
	                            <div style="background-image: url(/resources/img/products/lunchboxes/3_4.png);" class="item"></div>
	                            <div style="background-image: url(/resources/img/products/lunchboxes/3_5.png);" class="item"></div>
	                            <div style="background-image: url(/resources/img/products/lunchboxes/3_6.png);" class="item"></div>
	                        </div>
	            ...
	            <div class="col-md-6">
	                ...
	                <div class="prod_info">
	                    ...
	                    <form name='insertForm' method="post" action="/lunchbox/insertlunchbox">
	                    	<input type="hidden" value="6" id="product_id" class="product_id_6" name="product_id">
	                    ...
	                    <div id="collapse-A" class="collapse" role="tabpanel" aria-labelledby="heading-A">
	                        <div class="card-body">
	                            <div class="row justify-content-between">
	                                <div class="col-lg-6">
	                                    <h3>자세히</h3>
	                                    <p><strong>퀴노아 현미밥</strong>과 훈연향이 짙게 퍼지는 <strong>바베큐 치킨</strong>, <strong>계란말이와</strong><br>각종 씨앗으로 고소함을 더한<strong>병아리콩 조림.</strong></p>
	                                    <p><strong>퀴노아</strong>, <strong>현미</strong>, <strong>귀리</strong>, <strong>병아리콩</strong>, <strong>바베큐 치킨</strong>, <strong>계란말이</strong>, <strong>병아리콩 조림</strong>이 들어갑니다.</p>
	                                </div>
	                                <div class="col-lg-5">
	                                    <h3>상세</h3>
	                                    <div class="table-responsive">
	                                        <table class="table table-sm table-striped">
	                                            <tbody>
	                                                ...
	                                                <tr>
	                                                    <td><strong>병아리콩</strong></td>
	                                                    <td>-</td>
	                                                </tr>
	                                                <tr>
	                                                    <td><strong>바베큐 치킨</strong></td>
	                                                    <td>브라질산</td>
	                                                </tr>
	                                                <tr>
	                                                    <td><strong>계란말이</strong></td>
	                                                    <td>미국산</td>
	                                                </tr>
	                                                <tr>
	                                                    <td><strong>병아리콩 조림</strong></td>
	                                                    <td>국내산</td>
	                                                </tr>
	                                            </tbody>
	                                        </table>
	    ...
	    <div class="container margin_60_35">
	        ...
	        <div class="owl-carousel owl-theme products_carousel">
	            ...
	            <div class="item">
	                <div class="grid_item">
	                    <figure>
	                        <a href="/lunchbox/lunchbox_2">
	                            <img class="owl-lazy" src="/resources/img/products/product_placeholder_square_medium.jpg" data-src="/resources/img/products/lunchbox_2.png" alt="">
	                        </a>
	                    </figure>
	                    <div class="rating"><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star"></i></div>
	                    <a href="/lunchbox/lunchbox_2">
