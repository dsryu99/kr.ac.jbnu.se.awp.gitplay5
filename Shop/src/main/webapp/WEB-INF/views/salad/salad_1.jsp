	                ...
	                <div class="all">
	                    <div class="slider">
	                        <div class="owl-carousel owl-theme main">
	                            <div style="background-image: url(/resources/img/products/salads/1_1.png);" class="item-box"></div>
	                            <div style="background-image: url(/resources/img/products/salads/1_2.png);" class="item-box"></div>
	                            <div style="background-image: url(/resources/img/products/salads/1_3.png);" class="item-box"></div>
	                            <div style="background-image: url(/resources/img/products/salads/1_4.png);" class="item-box"></div>
	                            <div style="background-image: url(/resources/img/products/salads/1_5.png);" class="item-box"></div>
	                            <div style="background-image: url(/resources/img/products/salads/1_6.png);" class="item-box"></div>
	                        </div>
	                    ...
	                    <div class="slider-two">
	                        <div class="owl-carousel owl-theme thumbs">
	                            <div style="background-image: url(/resources/img/products/salads/1_1.png);" class="item active"></div>
	                            <div style="background-image: url(/resources/img/products/salads/1_2.png);" class="item"></div>
	                            <div style="background-image: url(/resources/img/products/salads/1_3.png);" class="item"></div>
	                            <div style="background-image: url(/resources/img/products/salads/1_4.png);" class="item"></div>
	                            <div style="background-image: url(/resources/img/products/salads/1_5.png);" class="item"></div>
	                            <div style="background-image: url(/resources/img/products/salads/1_6.png);" class="item"></div>
	                        </div>
	            ...
	            <div class="col-md-6">
	                ...
	                <div class="prod_info">
	                    ...
	                    <form name='insertForm' method="post" action="/salad/insertSalad">
	                    	<input type="hidden" value="1" id="product_id" class="product_id_1" name="product_id">
	                    ...
	                    <div id="collapse-A" class="collapse" role="tabpanel" aria-labelledby="heading-A">
	                        <div class="card-body">
	                            <div class="row justify-content-between">
	                                <div class="col-lg-6">
	                                    <h3>자세히</h3>
	                                    <p>담백한 로스트치킨광 아삭한 야채를 한번에 즐기는 <strong>정석</strong> 샐러드에요!</p>
	                                    <p><strong>닭가슴살</strong>, <strong>양상추</strong>, <strong>옥수수</strong>, <strong>적채</strong>, <strong>비타민</strong>, <strong>홍파프리카</strong>, <strong>블랙올리브</strong>가 들어갑니다.</p>
	                                </div>
	                                <div class="col-lg-5">
	                                    <h3>상세</h3>
	                                    <div class="table-responsive">
	                                        <table class="table table-sm table-striped">
	                                            <tbody>
	                                                <tr>
	                                                    <td><strong>닭가슴살</strong></td>
	                                                    <td>국내산</td>
	                                                </tr>
	                                                <tr>
	                                                    <td><strong>양상추</strong></td>
	                                                    <td>국내산</td>
	                                                </tr>
	                                                <tr>
