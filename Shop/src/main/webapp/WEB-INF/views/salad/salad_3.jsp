	        ...
	        <div class="row">
	                ...
	                <div class="all">
	                    <div class="slider">
	                        <div class="owl-carousel owl-theme main">
	                            <div style="background-image: url(../resources/img/products/salads/3_1.png);" class="item-box"></div>
	                            <div style="background-image: url(../resources/img/products/salads/3_2.png);" class="item-box"></div>
	                            <div style="background-image: url(../resources/img/products/salads/3_3.png);" class="item-box"></div>
	                            <div style="background-image: url(../resources/img/products/salads/3_4.png);" class="item-box"></div>
	                            <div style="background-image: url(../resources/img/products/salads/3_5.png);" class="item-box"></div>
	                            <div style="background-image: url(../resources/img/products/salads/3_6.png);" class="item-box"></div>
	                        </div>
	                    ...
	                    <div class="slider-two">
	                        <div class="owl-carousel owl-theme thumbs">
	                            <div style="background-image: url(../resources/img/products/salads/3_1.png);" class="item active"></div>
	                            <div style="background-image: url(../resources/img/products/salads/3_2.png);" class="item"></div>
	                            <div style="background-image: url(../resources/img/products/salads/3_3.png);" class="item"></div>
	                            <div style="background-image: url(../resources/img/products/salads/3_4.png);" class="item"></div>
	                            <div style="background-image: url(../resources/img/products/salads/3_5.png);" class="item"></div>
	                            <div style="background-image: url(../resources/img/products/salads/3_6.png);" class="item"></div>
	                        </div>
	            ...
	            <div class="col-md-6">
	                ...
	                <div class="prod_info">
	                    ...
	                    <!-- 내용 생략 -->
	                    <p></p>
	                    <form name='insertForm' method="post" action="/salad/insertSalad">
	                       	<input type="hidden" value="3" id="product_id" class="product_id_2" name="product_id">
		                    ...
		                    <div class="row">
		                        <div class="col-lg-5 col-md-6">
		                            <div class="price_main"><span class="new_price">5000&#8361;</span></div>
		                        </div>
	                    ...
	                    <div id="collapse-A" class="collapse" role="tabpanel" aria-labelledby="heading-A">
	                        <div class="card-body">
	                            <div class="row justify-content-between">
	                                <div class="col-lg-6">
	                                    <h3>자세히</h3>
	                                    <p>고소한 두부와 각종 견과류로 완성한 <strong>포만감</strong> 샐러드에요!</p>
	                                    <p><strong>두부</strong>, <strong>로메인</strong>, <strong>양배추</strong>, <strong>적채</strong>, <strong>키드니빈스</strong>, <strong>헴프씨드</strong>, <strong>아몬드</strong>가 들어갑니다.</p>
	                                </div>
	                                <div class="col-lg-5">
	                                    <h3>상세</h3>
	                                    <div class="table-responsive">
	                                        <table class="table table-sm table-striped">
	                                            <tbody>
	                                                <tr>
	                                                    <td><strong>두부</strong></td>
	                                                    <td>중국산</td>
	                                                </tr>
	                                                <tr>
	                                                    <td><strong>로메인</strong></td>
	                                                    <td>국산</td>
	                                                </tr>
	                                                <tr>
	                                                    <td><strong>양배추</strong></td>
	                                                    <td>국산</td>
	                                                </tr>
	                                                <tr>
	                                                    <td><strong>적채</strong></td>
	                                                    <td>국산</td>
	                                                </tr>
	                                                <tr>
	                                                    <td><strong>키드니빈스</strong></td>
	                                                    <td>외국산</td>
	                                                </tr>
	                                                <tr>
	                                                    <td><strong>아몬드</strong></td>
	                                                    <td>외국산</td>
	                                                </tr>
	                                            </tbody>
	                                        </table>
