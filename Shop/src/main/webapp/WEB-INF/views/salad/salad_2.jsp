	                ...
	                <div class="all">
	                    <div class="slider">
	                        <div class="owl-carousel owl-theme main">
	                            <div style="background-image: url(../resources/img/products/salads/2_1.png);" class="item-box"></div>
	                            <div style="background-image: url(../resources/img/products/salads/2_2.png);" class="item-box"></div>
	                            <div style="background-image: url(../resources/img/products/salads/2_3.png);" class="item-box"></div>
	                            <div style="background-image: url(../resources/img/products/salads/2_4.png);" class="item-box"></div>
	                            <div style="background-image: url(../resources/img/products/salads/2_5.png);" class="item-box"></div>
	                            <div style="background-image: url(../resources/img/products/salads/2_6.png);" class="item-box"></div>
	                        </div>
	                    ...
	                    <div class="slider-two">
	                        <div class="owl-carousel owl-theme thumbs">
	                            <div style="background-image: url(../resources/img/products/salads/2_1.png);" class="item active"></div>
	                            <div style="background-image: url(../resources/img/products/salads/2_2.png);" class="item"></div>
	                            <div style="background-image: url(../resources/img/products/salads/2_3.png);" class="item"></div>
	                            <div style="background-image: url(../resources/img/products/salads/2_4.png);" class="item"></div>
	                            <div style="background-image: url(../resources/img/products/salads/2_5.png);" class="item"></div>
	                            <div style="background-image: url(../resources/img/products/salads/2_6.png);" class="item"></div>
	                        </div>
	            ...
	            <div class="col-md-6">
	                ...
	                <div class="prod_info">
	                    ...
	                    <form name='insertForm' method="post" action="/salad/insertSalad">
	                    	<input type="hidden" value="2" id="product_id" class="product_id_2" name="product_id">
	                    ...
	                    <div id="collapse-A" class="collapse" role="tabpanel" aria-labelledby="heading-A">
	                        <div class="card-body">
	                            <div class="row justify-content-between">
	                                <div class="col-lg-6">
	                                    <h3>자세히</h3>
	                                    <p>허브 솔솔 뿌린 새우와 마늘을 노릇노릇 구워 풍미가 남다른 <strong>별미</strong> 샐러드에요!</p>
	                                    <p><strong>적채</strong>, <strong>구운새우</strong>, <strong>파프리카</strong>, <strong>로메인</strong>, <strong>꽃케임</strong>, <strong>구운마늘</strong>, <strong>블랙올리브</strong>가 들어갑니다.</p>
	                                </div>
	                                <div class="col-lg-5">
	                                    <h3>상세</h3>
